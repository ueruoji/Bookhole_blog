    ...
    public partial class user
    {
        ...
        public bool Exists(double User_id)
        {
            ...
            MySqlParameter[] parameters = {
                    new MySqlParameter("@User_id", MySqlDbType.Double,15)           };
        ...
        public bool Add(Bookhole_blog.Model.user model)
        {
            ...
            MySqlParameter[] parameters = {
                    ...
                    new MySqlParameter("@User_qq", MySqlDbType.Double,11),
                    new MySqlParameter("@User_phone", MySqlDbType.Double,11)};
        ...
        public Bookhole_blog.Model.user DataRowToModel(DataRow row)
        {
            ...
            if (row != null)
            {
                if (row["User_name"] != null) {
                    model.User_id = Convert.ToDouble(row["User_id"].ToString());
                }
                ...
                if (row["User_qq"] != null)
                {
                    model.User_qq = Convert.ToDouble(row["User_qq"].ToString());
                }
                if (row["User_phone"] != null) {
                    model.User_phone = Convert.ToDouble(row["User_phone"].ToString());
                }
