...
namespace Bookhole_blog.DAL
{
	...
	public partial class tell
	{
		...
		public int GetMaxId()
		{
		return DbHelperMySQL.GetMaxID("Tell_blogid", "tell"); 
		}
		...
		public bool Exists(int Tell_blogid)
		{
			...
			strSql.Append(" where Tell_blogid=@Tell_blogid ");
			MySqlParameter[] parameters = {
					new MySqlParameter("@Tell_blogid", MySqlDbType.Int32,11)			};
			parameters[0].Value = Tell_blogid;
		...
		public bool Add(Bookhole_blog.Model.tell model)
		{
			...
			strSql.Append("Tell_blogid,Tell_userid,Tell_text,Tell_time)");
		...
		public bool Update(Bookhole_blog.Model.tell model)
		{
			...
			MySqlParameter[] parameters = {
					...
					new MySqlParameter("@Tell_time", MySqlDbType.VarChar,255),
					new MySqlParameter("@Tell_blogid", MySqlDbType.Int32,11)};
			parameters[0].Value = model.Tell_userid;
			parameters[1].Value = model.Tell_text;
			parameters[2].Value = model.Tell_time;
			parameters[3].Value = model.Tell_blogid;
		...
		public bool DeleteList(string Tell_blogidlist )
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from tell ");
			strSql.Append(" where Tell_blogid in ("+Tell_blogidlist + ")  ");
		...
		public Bookhole_blog.Model.tell GetModel(int Tell_blogid)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Tell_blogid,Tell_userid,Tell_text,Tell_time from tell ");
			strSql.Append(" where Tell_blogid=@Tell_blogid ");
			MySqlParameter[] parameters = {
					new MySqlParameter("@Tell_blogid", MySqlDbType.Int32,11)			};
			parameters[0].Value = Tell_blogid;
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Tell_blogid,Tell_userid,Tell_text,Tell_time ");
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			{
				strSql.Append("order by T.Tell_blogid desc");
			}
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[1].Value = "Tell_blogid";
