...
namespace Bookhole_blog.BLL
{
    ...
    public partial class tell
    {
        ...
        {
            return dal.DeleteList(Maticsoft.Common.PageValidate.SafeLongFilter(Tell_idlist, 0));
        }
        ...
        public Bookhole_blog.Model.tell GetModel(int Tell_id)
        {
            ...
            return dal.GetModel(Tell_id);
        }

        /// <summary>
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public Bookhole_blog.Model.tell GetModelByCache(int Tell_id)
        {

            string CacheKey = "tellModel-" + Tell_id;
            object objModel = Maticsoft.Common.DataCache.GetCache(CacheKey);
            if (objModel == null)
            {
                try
                {
                    objModel = dal.GetModel(Tell_id);
                    if (objModel != null)
                    {
